...
console.log(`Lenght of myProducts array is ${myProducts.length}`);
...
// moidificarea unui element
myProducts[0] = 'Tricou';
console.log(`myProducts after changing first item:` , myProducts);

// stergerea unui element
myProducts.pop();
console.log(`myProducts after pop-ing list:` , myProducts);
...
console.log(`Elementul pantaloni se afla in lista la idexul ${indexOfPantaloni}`);
